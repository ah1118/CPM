/* ==========================================================
   AIRCRAFT — EC-NYJ (A330-300)
========================================================== */

const aircraft_ECNYJ = {
    registration: "EC-NYJ",
    type: "A330-300",
    ...
    layout: {
        ...
        aft: {
            akeLeft:  ["43L","42L","41L","34L","33L","32L"],
            akeRight: ["43R","42R","41R","34R","33R","32R"],
            pallet:   ["42P","41P","33P","32P"]
        }
    },
    ...
    containerPositions: [
        ...
        "43L","42L","41L","34L","33L","32L",
        "43R","42R","41R","34R","33R","32R"
    ],
